...
public class MyGcmListenerService extends GcmListenerService {
    ...
    private static final String TAG = "GCMMyGcmListenerService";
    ...
    public void onMessageReceived(String from, Bundle data) {
        ...
        String message = data.getString("preview");
        Integer fromUserId = Integer.valueOf(data.getString("fromUser"));
        Integer messageId = Integer.valueOf(data.getString("messageId"));
        Log.d(TAG, "From: " + fromUserId);
