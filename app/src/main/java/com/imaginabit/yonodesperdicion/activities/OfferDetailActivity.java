...
//
//        final Offer offer = (Offer) data.getSerializable("offer");
//
//        Log.d(TAG, "onCreate: ad: " + offer);
//        isFavorite = false;
//
//        if (offer == null) {
...
//            final String imageUri = Constants.HOME_URL + offer.getImageUrl();
//
...
//            categoriaText.setText(offer.getCategoria());
//
//
//            Log.d(TAG, "onCreate: " + offer.getStatusStr() + offer.getStatusColor());
//
//            if (offer.getStatusStr() == "entregado") {
...
//                row.setVisibility(View.GONE);
//            }
//            if (Utils.isEmptyOrNull(offer.getWeightKgStr())) {
...
//
//            AdUtils.fetchAd(offer.getId(), new AdUtils.FetchAdCallback() {
//                @Override
...
//
//                        observe(myOffer);
//                        myOffer.setLocation(AdUtils.calculateLocation(myOffer));
//
//                        Log.d(TAG, "done: mad: " + myOffer.getId());
//                    } else {
