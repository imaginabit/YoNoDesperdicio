...
public class OffersActivity extends NavigationBaseActivity
        ...
        if (!mGoogleApiClient.isConnected()) {
            ...
            try {
                ...
                if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                    ...
                    ActivityCompat.requestPermissions(OffersActivity.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION,Manifest.permission.ACCESS_FINE_LOCATION},
                            LOCATION_REQUEST);
...
//                showToast(mAddressOutput);
    ...
    private void showToast(String string) {
        Toast.makeText(OffersActivity.this, string, Toast.LENGTH_SHORT).show();
    }
